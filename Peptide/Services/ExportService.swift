    ...
    func exportPDF(protocols: [PeptideProtocol], entries: [ProtocolEntry], profile: UserProfile) -> Data {
        ...
        return renderer.pdfData { ctx in
            ...
            for (label, value) in [
                ...
                let _ = drawText(value, font: labelFont,
                                 x: pageWidth - margin - 60, width: 60, align: .right)
                y += h + 5
            }
            ...
            for proto in protocols {
                ...
                let _ = drawText(proto.status.rawValue.capitalized, font: captionFont,
                ...
                for entry in protoEntries.prefix(60) {
                    ...
                    let _ = drawText(entry.completed ? "Yes" : "No",
